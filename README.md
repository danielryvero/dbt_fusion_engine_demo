---
title: dbt Cloud Fusion Engine Demo
tags: [dbt, Fusion Engine, State-Awareness Orchestration]
...
## 2. Broad SQL comprehension and faster parsing
...
## 3. <span style="color:#2563eb;"><strong>Preview CTE</strong></span> button
...
## 4. Column lineage and references to it
...
## 6. “<span style="color:#2563eb;"><strong>Go to Definition</strong></span>” button
...
### Second Job Run shows similar results:
...
## 9. State Awareness Orchestration (SAO) enabled (Record inserted in Model)
...
### First Fusion <span style="color:#9d2d1d; font-weight:900;">State-Awared </span> Job run:
...
## 10. State Awareness Orchestration (SAO) enabled (Record inserted in Source)

### Record insertion in a Source
...
## 11. <span style="color:#9d2d1d; font-weight:600;">State-Awareness </span> testing in source without <span style="color:#b08968; font-weight:900;">loaded_at_field</span> configured in <span style="color:#f59e0b; font-weight:600;">source.yml</span>
...
## 12. Managing building frequency with advanced parameters:
...
## 13. Checking that <span style="color:#9d2d1d; font-weight:900;">State-Awareness </span> is also triggered by a code change in a model.
...
### <span style="color:#9d2d1d; font-weight:900;">State-Awared </span> Job triggering after code change:
...
## 14. Using <span style="color:#b08968; font-weight:900;">loaded_at_query</span> instead of <span style="color:#b08968; font-weight:900;">loaded_at_field</span>

The following configuration has been set for the HUB_CUSTOMER model:
![image 18](https://hackmd.io/_uploads/S1llbJmKbx.png)

### Record insertion within interval defined by <span style="color:#b08968; font-weight:600;">loaded_at_query</span> parameter
...
## 15. Inserting a record in a different source than the one with the <span style="color:#b08968; font-weight:600;">loaded_at_query</span> field configured
...
## 16. How does dbt detect insertion of records into tables?
